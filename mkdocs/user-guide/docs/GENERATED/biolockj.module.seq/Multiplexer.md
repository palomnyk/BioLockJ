...
| :--- | :--- |
| *metadata.barcodeColumn* | *string* <br>metadata column with identifying barcodes to use.<br>*default:  BarcodeSequence* |
| *multiplexer.gzip* | *boolean* <br>if enabled the multiplexed output will be gzipped<br>*default:  Y* |
